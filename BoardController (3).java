package kr.co.openeg.sec.lab.board.controller;
...
import kr.co.openeg.sec.lab.board.model.BoardCommentModel;
import kr.co.openeg.sec.lab.board.model.BoardModel;
import kr.co.openeg.sec.lab.board.service.BoardService;
...
public class BoardController {
	...
	public void getImage(HttpServletRequest request, HttpSession session, 
		...
		// 저장된 파일명을 가져올것
		BoardModel board=
				(BoardModel)session.getAttribute("board");
		if ( filename.equals(board.getFileName())) {
			filename=board.getSavedFileName();
		}else {
			return;
		}
